...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="4">
  <g fill="none" stroke="currentColor" stroke-width="4">
    <path stroke-linejoin="round" d="M4 33a2 2 0 0 1 2-2h6v-7l12-8l12 8v7h6a2 2 0 0 1 2 2v9a2 2 0 0 1-2 2H4V33Z"/>
    <path stroke-linecap="round" d="M24 6v10"/>
    <path stroke-linecap="round" stroke-linejoin="round" d="M36 12V6s-1.5 3-6 0s-6 0-6 0v6s1.5-3 6 0s6 0 6 0Zm-8 32V31h-8v13m-2 0h12"/>
  </g>
</svg>`;
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="24" height="24" fill="#000000">
  <path fill-rule="evenodd" clip-rule="evenodd" d="M8 14.5a6.47 6.47 0 0 0 3.25-.87V11.5A2.25 2.25 0 0 0 9 9.25H7a2.25 2.25 0 0 0-2.25 2.25v2.13A6.47 6.47 0 0 0 8 14.5Zm4.75-3v.937a6.5 6.5 0 1 0-9.5 0V11.5a3.752 3.752 0 0 1 2.486-3.532a3 3 0 1 1 4.528 0A3.752 3.752 0 0 1 12.75 11.5ZM8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16ZM9.5 6a1.5 1.5 0 1 1-3 0a1.5 1.5 0 0 1 3 0Z"/>
</svg>
`;

export const universityLogo = `
<svg viewBox="-50 0 750 350" xmlns="http://www.w3.org/2000/svg">
    <g fill="none" stroke-linejoin="round" stroke-width="8" stroke="currentColor">
        <path d="M-15,0 L-15,115" stroke-linecap="butt"/>
        <path d="M55,40 L55,100" stroke-linecap="butt"/>
        <path d="M65,80 L65,100" stroke-width="23" stroke-linecap="butt"/>
        <path d="M75,40 L75,100" stroke-linecap="butt"/>
        <path d="M145,0 L145,150" stroke-linecap="butt"/>
        <path d="M-15,0 L55,40" stroke-linecap="round"/>
        <path d="M75,40 L145,0" stroke-linecap="round"/>
    </g>
</svg>
`;
